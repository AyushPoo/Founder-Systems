...
function MarketCircles({ headline, tam, sam, som, up, updateNested, t }: any) {
  const items = [
    { key: 'tam', data: tam, def: '$40B',  color: t.accent,      bg: `${t.accent}0f`, size: 680, label: 'TAM — Total Addressable Market' },
    { key: 'sam', data: sam, def: '$8B',   color: t.accentLight, bg: `${t.accent}1a`, size: 460, label: 'SAM — Serviceable Available Market' },
    { key: 'som', data: som, def: '$800M', color: '#C4B5FD',     bg: `${t.accent}2e`, size: 280, label: 'SOM — Obtainable Market' },
  ]
  return (
...
function MarketBars({ headline, tam, sam, som, up, updateNested, t }: any) {
  const tiers = [
    { key: 'tam', data: tam, def: '$40B',  label: 'TAM', sub: 'Total Addressable Market',    color: t.accent,      pct: 100 },
    { key: 'sam', data: sam, def: '$8B',   label: 'SAM', sub: 'Serviceable Available Market', color: t.accentLight, pct: 55  },
...
export function MarketSlide({ headline, tam, sam, som, layout = 'circles', slideIndex, deckStyle }: Props) {
