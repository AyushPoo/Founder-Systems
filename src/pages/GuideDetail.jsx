                        ...
                        <div className="lg:sticky lg:top-28">
                            ...
                            <div className="mt-6 flex items-center gap-3 text-sm font-black uppercase tracking-[0.14em] text-brand-black/52">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="inline-flex h-11 w-11 items-center justify-center rounded-full border-2 border-brand-black bg-white transition hover:-translate-y-0.5 hover:bg-brand-cream"
                                    aria-label="Share on X"
                                >
                                    <svg className="w-4 h-4 text-brand-black" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                >
                                    <svg className="w-4 h-4 text-brand-black" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
