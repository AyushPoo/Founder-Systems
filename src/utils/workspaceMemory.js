...
export function buildSpecMemoryCandidates(session = {}) {
  ...
  return compactCandidates([
    ...
    createCandidate({
      ...
      text: brief.customer || brief.icp,
      summary: brief.customer || brief.icp,
      source_product: 'founder-spec-generator',
    }),
    createCandidate({
      memory_scope: 'canonical',
      type: 'buyer_role',
      label: 'Buyer role',
      text: brief.buyerRole || brief.icp,
      summary: brief.buyerRole || brief.icp,
      source_product: 'founder-spec-generator',
    }),
    createCandidate({
      memory_scope: 'canonical',
    ...
    createCandidate({
      ...
      type: 'offer',
      label: 'Offer',
      text: brief.solution || brief.wedge || recommendation.summary || recommendation.what,
      summary: brief.solution || brief.wedge || recommendation.summary,
      source_product: 'founder-spec-generator',
    }),
    createCandidate({
      memory_scope: 'canonical',
      ...
      text: brief.pricing || brief.pricingHypothesis,
      summary: brief.pricing || brief.pricingHypothesis,
      source_product: 'founder-spec-generator',
    }),
    createCandidate({
      memory_scope: 'canonical',
