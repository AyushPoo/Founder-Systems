...
export const CONNECTOR_CATALOG = [
  {
    ...
    phase: 'live',
    agents: ['Blair (Marketing Operator)', 'Link (Ops Operator)'],
  ...
  },
  {
    ...
    group: 'Google Workspace',
    phase: 'planned',
    agents: ['Blair (Marketing Operator)', 'Ledger (Finance Operator)', 'Link (Ops Operator)'],
  ...
  },
  {
    ...
    group: 'Google Workspace',
    phase: 'planned',
    agents: ['Ledger (Finance Operator)', 'Link (Ops Operator)'],
  ...
  },
  {
    ...
    group: 'Google Workspace',
    phase: 'planned',
    agents: ['Blair (Marketing Operator)', 'Ledger (Finance Operator)'],
  ...
  },
  {
    ...
    phase: 'planned',
    agents: ['Blair (Marketing Operator)'],
  ...
  },
  {
    ...
    group: 'Finance',
    phase: 'planned',
    agents: ['Ledger (Finance Operator)'],
  ...
  },
  {
    ...
    group: 'Customer Support',
    phase: 'planned',
    agents: ['Link (Ops Operator)', 'Blair (Marketing Operator)'],
