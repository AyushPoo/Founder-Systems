  ...
  if (request.jobDescription === '__summarize_only__' || requestBody?.jobDescription === '__summarize_only__') {
    ...
    try {
      const modelResult = await invokeFounderJsonModel({
        ...
        systemPrompt: 'Create a candidate card that balances brevity with enough detail to make a decision.\n\nReturn ONLY JSON:\n{"ok":true,"domain":"sector","seniority":"Entry/Mid/Senior/Founder","tagline":"Current Role | Key Background | Top Credential (one line)","background":"3-4 sentences. What they do now, key companies with time periods, trajectory. Include years.","goodFor":"2-3 specific roles they would excel at","career":[{"company":"Name","role":"Title","period":"2021-2023","note":"one line what they did"}],"credentials":"All qualifications in one line: degrees, certifications, MBA etc","topSkills":["max 6 skills"]}\n\nRules:\n- tagline: Punchy one-liner. E.g. "Founder (GradeSense) | Ex-KPMG Audit | CFA L1 | MBA Scaler"\n- background: Include company names AND time periods. 3-4 sentences covering full career arc.\n- career: List each company separately with role, period, and one-line note\n- credentials: ALL education + certs in one line, comma separated\n- goodFor: Be specific about what roles/contexts suit them\n- If FOUNDER, put that first everywhere\n- Do NOT use "passionate" or "driven by" or "committed to"',
        userPrompt: 'Candidate card with company details and time periods. Be specific but compact.\n\n' + profileText.slice(0, 4000),
        maxOutputTokens: 550,
        modelTier: 'quality',
